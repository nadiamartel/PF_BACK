...
const sendMailReservation = async (user) => {
  ...
  const info = await transporter.sendMail({
    ...
    <p style="margin: 0; text-align: center; mso-line-height-alt: 32.4px;"><u><span style="font-size:18px;"><strong><span style="">Horario:</span></strong></span></u><span style="font-size:18px;"><strong><span style=""> </span></strong><span style="">${user?.hour}</span></span></p>
